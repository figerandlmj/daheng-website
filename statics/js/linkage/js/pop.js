...
//content =  '<a href="javascript:;" onclick=\'set_val("'+nodename+'",'+nodeid+'); $("input[name=info['+returnid+']]").val('+nodeid+'); art.dialog({id:"edit_'+returnid+'"}).close(); \' style="color:red;font-weight:bold">'+nodename+'</a>';